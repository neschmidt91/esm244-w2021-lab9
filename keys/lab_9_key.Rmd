...
We'll use the `LifeCycleSavings` built-in dataset. See `?LifeCycleSavings` for more information on the included variables. 

Simplify it a bit to get the 5 countries with the lowest savings ratio:
...
And you can bootstrap all kinds of other things too (medians, variances, correlations, regression coefficients, etc.).
